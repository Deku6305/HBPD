...
let w = (c.width = window.innerWidth),
  ...
  hh = h / 2,
  opts = {
    strings: ["HAPPY", "BIRTHDAY!", "NGUYỄN THỊ NHƯ HUỲNH❤️"],
    charSize: 20,
    charSpacing: 25,
    lineHeight: 30,
...
function hienThu() {
  document.getElementById("thu-chuc").style.display = "block";
}

function anThu() {
  document.getElementById("thu-chuc").style.display = "none";
}